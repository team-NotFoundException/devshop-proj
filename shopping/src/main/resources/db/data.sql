...
VALUES
    ...
    'thumb_tshirt_1.jpg', 'ACTIVE', 1, NOW(), 'profile_tshirt_1.jpg'),

    ('데일리 후드티', 'HOODIE-001', 32000.00, 50, '캐주얼 데일리용 후드티',
    'thumb_hoodie_1.jpg', 'ACTIVE', 1, NOW(), 'profile_hoodie_1.jpg'),

    ('슬림 데님 팬츠', 'JEANS-001', 45000.00, 30, '슬림핏 청바지',
    'thumb_jeans_1.jpg', 'ACTIVE', 2, NOW(), 'profile_jeans_1.jpg'),

    ('코튼 팬츠', 'PANTS-001', 38000.00, 40, '편안한 착용감의 면 바지',
    'thumb_pants_1.jpg', 'ACTIVE', 2, NOW(), 'profile_pants_1.jpg'),

    ('베이직 양말', 'SOCKS-001', 12000.00, 200, '사계절용 기본 양말',
    'thumb_socks_1.jpg', 'ACTIVE', 3, NOW(), 'profile_socks_1.jpg'),

    ('윈드브레이커', 'JACKET-001', 55000.00, 20, '가벼운 바람막이 자켓',
    'thumb_jacket_1.jpg', 'ACTIVE', 4, NOW(), 'profile_jacket_1.jpg'),

    ('다운 패딩', 'PADDING-001', 89000.00, 15, '겨울용 패딩 자켓',
    'thumb_padding_1.jpg', 'ACTIVE', 4, NOW(), 'profile_padding_1.jpg'),

    ('베이직 볼캡', 'CAP-001', 27000.00, 60, '심플한 디자인의 볼캡',
    'thumb_cap_1.jpg', 'ACTIVE', 3, NOW(), 'profile_cap_1.jpg'),

    ('캔버스 에코백', 'BAG-001', 22000.00, 80, '데일리용 에코백',
    'thumb_bag_1.jpg', 'ACTIVE', 3, NOW(), 'profile_bag_1.jpg'),

    ('나시 티셔츠', 'SLEEVELESS-001', 18000.00, 0, '여름용 민소매 티셔츠',
    'thumb_sleeveless_1.jpg', 'SOLD_OUT', 1, NOW(), 'profile_sleeveless_1.jpg');
